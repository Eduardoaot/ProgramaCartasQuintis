...
export default function InfoBlock({ titulo, children, delay = 0 }) {
  return (
    <Reveal
      delay={delay}
      className="rounded-2xl border-l-4 border-rosa bg-(--surface) p-6 text-left shadow-[0_6px_16px_rgba(142,36,83,0.10)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_16px_30px_rgba(142,36,83,0.20)]"
    >
