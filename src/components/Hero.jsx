...
export default function Hero() {
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -top-16 -left-16 -z-10 h-64 w-64 animate-blob rounded-full bg-dorado opacity-30 blur-[50px]"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-24 -right-20 -z-10 h-72 w-72 animate-blob rounded-full bg-rosa opacity-30 blur-[50px] [animation-delay:-5s]"
      />
      <span
        aria-hidden="true"
        className="pointer-events-none absolute right-[10%] top-[40%] -z-10 h-44 w-44 animate-blob rounded-full bg-dorado opacity-25 blur-[50px] [animation-delay:-9s]"
      />
      ...
      <a
        href={hero.cta.href}
        className="group relative mt-2 inline-flex animate-fade-up items-center gap-2 overflow-hidden rounded-full bg-vino px-9 py-3.5 font-bold text-white shadow-[0_10px_25px_rgba(0,0,0,0.3)] transition duration-300 [animation-delay:0.6s] hover:-translate-y-1 hover:bg-rosa hover:shadow-[0_14px_30px_rgba(0,0,0,0.35)]"
      >
        <span
          aria-hidden="true"
